...
platform_list = {  
  ...
  'stm32f2' : { 'cpus' : [ 'STM32F207IG', 'STM32F217VG' ], 'toolchains' : [ 'arm-gcc', 'codesourcery', 'devkitarm', 'arm-eabi-gcc' ] },
  'stm32f4' : { 'cpus' : [ 'STM32F407VG', 'STM32F407IG' ], 'toolchains' : [ 'arm-gcc', 'codesourcery', 'devkitarm', 'arm-eabi-gcc' ] },
