...
specific_files = "core_cm3.c system_stm32f2xx.c startup_stm32f2xx.s platform.c stm32f2xx_it.c platform_int.c"
...
comp.Append(CPPDEFINES = [ 'USE_STDPERIPH_DRIVER', 'CORTEX_M3'])
...
tools[ 'stm32f2' ][ 'progfunc' ] = progfunc_stm32
